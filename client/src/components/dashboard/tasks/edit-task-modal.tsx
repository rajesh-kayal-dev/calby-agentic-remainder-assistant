...
export function EditTaskModal({
  ...
  const [taskListId, setTaskListId] = useState<string>(task.task_list_id || "");
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-zinc-800/80 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-white leading-tight">Edit Task</h2>
              <p className="text-xs text-zinc-400">Update task details or schedule</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={2}
              className="w-full rounded-xl border border-zinc-800 bg-zinc-900 p-3 text-xs text-zinc-200 focus:border-lime-400/50 focus:outline-none resize-none"
            />
          </div>
